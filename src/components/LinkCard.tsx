        ...
        return (
            <li className={`relative group`}>
                <div className={`flex items-center w-full cursor-pointer hover:bg-cyan-400 md:hover:bg-transparent group`}>
                    <Link href={link} className={`group-hover:text-white md:group-hover:text-slate-700 font-medium ${activeLink} text-[.9rem] py-2 px-[.65rem] text-slate-600 hover:text-white hover:bg-cyan-400 md:hover:bg-transparent md:hover:text-slate-700 flex gap-1 items-center`}>{title}</Link>
                ...
                {/* <ul className={`transition-all duration-300 relative md:absolute z-[888] overflow-hidden top-full left-0 border-0 border-t-2 w-full md:min-w-[15rem] md:max-w-[25rem] md:shadow-md ${dropdown ? 'border-indigo-200 max-h-max' : 'border-t-transparent max-h-0'} hover:max-h-max flex-col bg-white`}> */}
                <ul className={`transition-all duration-300 relative md:absolute z-[888] overflow-hidden top-full left-0 border-0 border-t-2 w-full md:min-w-[15rem] md:w-max md:shadow-md group-hover:border-indigo-200 group-hover:max-h-max border-t-transparent max-h-0 flex-col bg-white`}>
