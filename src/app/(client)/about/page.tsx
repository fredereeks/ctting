...
export default async function page() {
    return (
        <main className="bg-slate-50 pb-20">
            ...
            <div className="container pt-10 px-4 mx-auto flex flex-col">
                ...
                <div className="flex flex-col gap-2">
                    <aside className={`py-2 flex flex-col gap-1 md:gap-5 md:items-center md:flex-row`}>
                    ...
                    <aside className={`py-2 flex flex-col gap-1 md:gap-5 md:items-center md:flex-row-reverse`}>
                        <div className="relative  px-4 md:p-2 mx-auto h-[250px] md:h-full w-[250px] md:flex-1 flex-shrink-0 bg-white rounded-md">
                ...
                <section className="difference py-20 sm:px-4 bg-[#f8f8fa90]">
                    <aside className="col-span-2 flex flex-col justify-center gap-2 md:max-w-[85%] md:mx-auto p-4">
                        <h3 className="text-2xl md:text-4xl font-bold text-primary md:text-center">Why are we different from other?</h3>
